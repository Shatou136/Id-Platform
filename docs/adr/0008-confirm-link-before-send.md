...
Superseded by ADR 0014 for the in-app confirm click. Photos still belong in files.
...
Photos belong in files, not in the Request row. v1 writes them under `data/photos/` and serves `/api/photos/...`.
